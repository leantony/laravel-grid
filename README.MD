...
```
> For bootstrap 3 support, consider installing version `1.0`. Version 1.0 though is preety not much updated at this point, so may lack some features.
...
# Next up
[Customization of the grid](docs/customization.md)
